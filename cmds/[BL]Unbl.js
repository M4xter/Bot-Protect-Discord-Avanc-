...
exports.run = async (bot, message, args) => {
    ...
    if (!db.get("🔧➔Team Blacklist").find({ user_id: author }).value()) {
        message.channel.send("<a:Alerte1:754441316905123994>  __**Uniquement les owners peux utiliser cette commande !**__ <a:Cheh22:785554431324192839>"); //Check De Permissions.
    } else {
